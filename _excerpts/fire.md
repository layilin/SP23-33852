...
This excerpt about the fire at midnight not only shows that the plantations are often vulnerable to catastrophes of fire and natural disasters but also hints at the tensions that existed between enslaved laborers and their enslavers. Fire was an essential element to the transformation of sugarcane into sugar: after being crushed, sugarcane had to be boiled to create a syrup, which was then crystallized to produce sold sugar. At the same time, fire could cause disasters and threaten to destroy the entire plantation, especially if it was deployed as a tool of resistance and rebellion. 
